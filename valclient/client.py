...
class Client:
    ...
    def put_player_loadout(self, loadout: dict) -> dict:
        ...
        '''
        data = self.put(endpoint=f"/personalization/v2/players/{self.puuid}/playerloadout", endpoint_type="pd",
                        json_data=loadout)
        return data
    ...
    def fetch_match_history(self, puuid: str = None, start_index: int = 0, end_index: int = 15,
                            queue_id: str = "null") -> dict:
        '''
        ...
        data = self.fetch(
            endpoint=f"/match-history/v1/history/{puuid}?startIndex={start_index}&endIndex={end_index}" + (
                f"&queue={queue_id}" if queue_id != "null" else ""), endpoint_type="pd")
        return data
    ...
    def fetch_competitive_updates(self, puuid: str = None, start_index: int = 0, end_index: int = 15,
                                  queue_id: str = "competitive") -> dict:
        '''
    ...
    def fetch_player_name(self):
        return self.put(endpoint="/name-service/v2/players", json_data=[self.puuid])
    ...
    def party_set_member_ready(self, ready: bool) -> dict:
        ...
        '''
        party_id = self.__get_current_party_id()
        data = self.post(endpoint=f"/parties/v1/parties/{party_id}/members/{self.puuid}/setReady", endpoint_type="glz",
    ...
    def party_refresh_competitive_tier(self) -> dict:
        ...
        '''
        party_id = self.__get_current_party_id()
        data = self.post(endpoint=f"/parties/v1/parties/{party_id}/members/{self.puuid}/refreshCompetitiveTier",
                         endpoint_type="glz")
        return data
    ...
    def party_refresh_player_identity(self) -> dict:
        ...
        '''
        party_id = self.__get_current_party_id()
        data = self.post(endpoint=f"/parties/v1/parties/{party_id}/members/{self.puuid}/refreshPlayerIdentity",
                         endpoint_type="glz")
        return data
    ...
    def party_refresh_pings(self) -> dict:
        ...
        '''
        party_id = self.__get_current_party_id()
        data = self.post(endpoint=f"/parties/v1/parties/{party_id}/members/{self.puuid}/refreshPings",
                         endpoint_type="glz")
        return data
    ...
    def party_change_queue(self, queue_id: str) -> dict:
        ...
        self.__check_queue_type(queue_id)
        party_id = self.__get_current_party_id()
        data = self.post(endpoint=f"/parties/v1/parties/{party_id}/queue", endpoint_type="glz",
    ...
    def set_party_accessibility(self, open: bool) -> dict:
        ...
        party_id = self.__get_current_party_id()
        data = self.post(endpoint=f"/parties/v1/parties/{party_id}/accessibility", endpoint_type="glz",
    ...
    def party_set_custom_game_settings(self, settings: dict) -> dict:
        ...
        '''
        party_id = self.__get_current_party_id()
        data = self.post(endpoint=f"/parties/v1/parties/{party_id}/customgamesettings", endpoint_type="glz",
                         json_data=settings)
        return data
